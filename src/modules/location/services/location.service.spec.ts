...
describe('LocationService', () => {
    ...
    describe('create', () => {
        ...
        it('should create a new location', async () => {
            ...
            expect(result).toEqual(mockLocation);
            expect(mockLocationRepository.create).toHaveBeenCalledWith(createLocationDto);
        });
    });
    ...
    describe('update', () => {
        ...
        it('should update a location', async () => {
            mockLocationRepository.findById.mockResolvedValue(mockLocation);
            mockLocationRepository.update.mockResolvedValue({ ...mockLocation, ...updateLocationDto });
        ...
        it('should throw EntityNotFoundException when location not found', async () => {
            ...
            await expect(service.update(1, updateLocationDto)).rejects.toThrow(EntityNotFoundException);
        });
    });
